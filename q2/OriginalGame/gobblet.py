    ...
    def draw_board(self, surface):
        ...
        for row in range(ROWS + 1):
            pygame.draw.line(surface, BLACK, 
                             ...
                             (BOARD_OFFSET_X + COLS * CELL_SIZE, BOARD_OFFSET_Y + row * CELL_SIZE), 2)
        for col in range(COLS + 1):
            pygame.draw.line(surface, BLACK,
                             (BOARD_OFFSET_X + col * CELL_SIZE, BOARD_OFFSET_Y),
                             (BOARD_OFFSET_X + col * CELL_SIZE, BOARD_OFFSET_Y + ROWS * CELL_SIZE), 2)
...
def main():
    ...
    while True:
        ...
        if game.game_over:
            ...
            text_rect = text_surf.get_rect(center=(SCREEN_WIDTH // 2, 10 + text_surf.get_height() // 2))
